  ...
  return (
    <div className="fixed bottom-6 left-6 z-50 flex flex-col items-start gap-3">
      ...
      <motion.a
        ...
        className="group relative flex size-14 items-center justify-center rounded-full bg-[#25D366] shadow-lg shadow-[#25D366]/30 transition-all duration-300 hover:shadow-xl hover:shadow-[#25D366]/40 hover:scale-110"
        whileTap={{ scale: 0.95 }}
