...
function Hero() {
  ...
  return (
    <section className="relative flex min-h-[70vh] items-center justify-center overflow-hidden px-4 pt-24 pb-16 md:pt-36 md:pb-20 lg:pt-40 lg:pb-24">
      ...
      >
        ...
        <motion.p
          variants={fadeInUp}
          className="mx-auto mt-6 max-w-2xl text-sm text-muted-foreground sm:text-base md:text-lg"
        >
...
function OurStory() {
  return (
    <AnimatedSection className="px-4 py-16 md:py-28 lg:py-32">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:gap-16">
          ...
          <motion.div variants={slideInLeft} className="flex flex-col justify-center">
            <h3 className="mb-4 text-xl font-bold tracking-tight sm:text-2xl md:text-3xl">
