    ...
    <motion.div variants={fadeInUp}>
      <Card className="glass border-transparent transition-all duration-300 hover:border-primary/30 hover:shadow-lg hover:shadow-primary/5">
        <button
          ...
          className="flex w-full min-h-[44px] items-center justify-between p-4 text-left sm:p-5 md:p-6"
...
export default function ContactPage() {
  ...
  return (
    <>
      ...
      {/* ─────────────── Hero Section ─────────────── */}
      <section className="relative px-4 pt-24 pb-12 md:pt-36 md:pb-16 lg:pt-40 lg:pb-20">
        ...
        <div className="relative z-10 mx-auto max-w-7xl">
          ...
          >
            ...
            <motion.div
              variants={fadeInUp}
              className="mt-6 flex flex-wrap items-center justify-center gap-4 text-sm text-muted-foreground sm:gap-6"
            >
      ...
      <AnimatedSection
        id="contact-form"
        className="px-4 py-12 md:py-20 lg:py-24"
      >
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    <div className="grid gap-5 sm:grid-cols-2">
                      <div>
                        ...
                        <Input
                          ...
                          className="min-h-[44px] bg-input/30 transition-all duration-300 focus:bg-input/50"
                        />
                      </div>
                      <div>
                        <label
                    ...
                    <div className="grid gap-5 sm:grid-cols-2">
                      ...
                      <div>
                        ...
                        >
                          <SelectTrigger className="min-h-[44px] bg-input/30 transition-all duration-300 focus:bg-input/50">
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        onChange={handleChange}
                        className="min-h-[44px] resize-none bg-input/30 transition-all duration-300 focus:bg-input/50"
                      />
                    </div>
      ...
      {/* ─────────────── Map / Office Section ─────────────── */}
      <AnimatedSection className="px-4 py-12 md:py-20 lg:py-24">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <motion.div variants={fadeInUp} className="sm:col-span-2 lg:col-span-2">
              <Card className="glass h-full border-transparent transition-all duration-300 hover:border-primary/30 hover:shadow-lg hover:shadow-primary/5">
                <CardContent className="p-0">
                  <div className="relative flex min-h-[220px] items-center justify-center overflow-hidden rounded-t-xl bg-gradient-to-br from-primary/5 via-primary/10 to-primary/5 sm:min-h-[300px] md:min-h-[360px]">
            ...
            {/* Office details card */}
            <motion.div variants={fadeInUp} className="flex flex-col gap-4 sm:col-span-2 lg:col-span-1">
              <Card className="glass border-transparent transition-all duration-300 hover:border-primary/30 hover:shadow-lg hover:shadow-primary/5">
